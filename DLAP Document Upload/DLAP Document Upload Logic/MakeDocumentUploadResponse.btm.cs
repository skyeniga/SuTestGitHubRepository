namespace SBA.DLAPDocumentUpload.Logic {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"DLAPDocumentUploadSalesForceDefinition.Rest.RestContentDocumentLink+results", typeof(global::DLAPDocumentUploadSalesForceDefinition.Rest.RestContentDocumentLink.results))]
    ...
    public sealed class MakeDocumentUploadResponse : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:s0=""http://SBA.gov/DLAPDocumentUpload/REST/INSERT/RestContentDocumentLink"" xmlns:ns0=""http://DocumentUploadDefinition.DocumentUpload"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
...
public bool ValToBool(string val)
{
	...
	return false;
        ...
        private const string _strSrcSchemasList0 = @"DLAPDocumentUploadSalesForceDefinition.Rest.RestContentDocumentLink+results";
        
        private const global::DLAPDocumentUploadSalesForceDefinition.Rest.RestContentDocumentLink.results _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"DLAPDocumentUploadSalesForceDefinition.Rest.RestContentDocumentLink+results";
                return _SrcSchemas;
            }
        }
