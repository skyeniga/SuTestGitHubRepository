namespace SBA.DLAPDocumentUpload.SalesForceDefinition {
    ...
    public sealed class SalesforceQuery_Application__c : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""Response"">
    <xs:complexType>
      ...
      <xs:attribute name=""AffectedRows"" type=""xs:int"" />
        ...
        public SalesforceQuery_Application__c() {
        }
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/Application__c",@"Request")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/Application__c",@"Response")]
        [System.SerializableAttribute()]
