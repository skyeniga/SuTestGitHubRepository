namespace DLAPDocumentUploadSalesForceDefinition.Rest {
    ...
    public sealed class RestChecklistItem : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""results"">
    <xs:complexType>
      <xs:sequence>
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/REST/UPDATE/RestChecklistItem",@"SaveRequest")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/REST/UPDATE/RestChecklistItem",@"results")]
        [System.SerializableAttribute()]
