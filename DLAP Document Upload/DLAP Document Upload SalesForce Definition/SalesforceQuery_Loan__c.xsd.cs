namespace DLAPDocumentUploadSalesForceDefinition {
    ...
    public sealed class SalesforceQuery_Loan__c : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" attributeFormDefault=""unqualified"" elementFormDefault=""qualified"" targetNamespace=""http://SBA.gov/DLAPDocumentUpload/Loan__c"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""Response"">
    <xs:complexType>
      ...
      <xs:attribute name=""AffectedRows"" type=""xs:int"" />
        ...
        public SalesforceQuery_Loan__c() {
        }
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/Loan__c",@"Request")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/Loan__c",@"Response")]
        [System.SerializableAttribute()]
