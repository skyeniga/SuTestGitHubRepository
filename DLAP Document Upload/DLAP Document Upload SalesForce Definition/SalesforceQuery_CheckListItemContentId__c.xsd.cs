namespace DLAPDocumentUploadSalesForceDefinition {
    ...
    public sealed class SalesforceQuery_CheckListItemContentId__c : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" attributeFormDefault=""unqualified"" elementFormDefault=""qualified"" targetNamespace=""http://SBA.gov/DLAPDocumentUpload/CheckListItemContentId__c"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""Request"">
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""SQLCommand"" type=""xs:string"" />
        <xs:element name=""CheckListItemSFID"" type=""xs:string"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  <xs:element name=""Response"">
    <xs:complexType>
      ...
      <xs:attribute name=""AffectedRows"" type=""xs:int"" />
        ...
        public SalesforceQuery_CheckListItemContentId__c() {
        }
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/CheckListItemContentId__c",@"Request")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://SBA.gov/DLAPDocumentUpload/CheckListItemContentId__c",@"Response")]
        [System.SerializableAttribute()]
