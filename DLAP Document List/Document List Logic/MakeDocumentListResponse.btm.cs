namespace DocumentListLogic {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_Document_Details", typeof(global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_Document_Details))]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Document_Details+QueryResult", typeof(global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Document_Details.QueryResult))]
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_ChecklistItem_Document_Details", typeof(global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_ChecklistItem_Document_Details))]
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 s1 s4 s3 s5 s2 userCSharp"" version=""1.0"" xmlns:s0=""http://SBA.gov/DLAPDocumentList/Checklist_Item__c"" xmlns:ns0=""http://SBA.gov/DLAPDocumentList/DocumentListResponse"" xmlns:s1=""http://SBA.gov/REST/AppDocumentList"" xmlns:s4=""http://SBA.gov/REST/ClosingDocumentsDocumentList"" xmlns:s3=""http://schemas.microsoft.com/BizTalk/2003/aggschema"" xmlns:s5=""http://SBA.gov/DLAP/DocumentList"" xmlns:s2=""http://SBA.gov/DLAPDocumentList/Application_Info__c"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s3:Root"">
    <ns0:DOCUMENT>
      <AppData>
        <xsl:if test=""InputMessagePart_2/s2:Response/s2:row/s2:ApplicationName"">
          <App_Nbr>
            <xsl:value-of select=""InputMessagePart_2/s2:Response/s2:row/s2:ApplicationName/text()"" />
          </App_Nbr>
        </xsl:if>
        <xsl:if test=""InputMessagePart_2/s2:Response/s2:row/s2:ApplicationLoanType"">
          <Loan_Type>
            <xsl:value-of select=""InputMessagePart_2/s2:Response/s2:row/s2:ApplicationLoanType/text()"" />
          </Loan_Type>
        </xsl:if>
        <xsl:if test=""InputMessagePart_2/s2:Response/s2:row/s2:Disaster_Name"">
          <Disaster_Name>
            <xsl:value-of select=""InputMessagePart_2/s2:Response/s2:row/s2:Disaster_Name/text()"" />
          </Disaster_Name>
        </xsl:if>
        ...
        <xsl:if test=""InputMessagePart_2/s2:Response/s2:row/s2:DisasterDeadlineDate"">
          <Disaster_Deadline_Date>
            <xsl:value-of select=""InputMessagePart_2/s2:Response/s2:row/s2:DisasterDeadlineDate/text()"" />
          </Disaster_Deadline_Date>
        </xsl:if>
      </AppData>
      <ApplicantList>
        <xsl:for-each select=""InputMessagePart_2/s2:Response/s2:row"">
          <xsl:variable name=""var:v1"" select=""userCSharp:LogicalExistence(boolean(s2:ApplicantId))"" />
          <xsl:if test=""$var:v1"">
            <xsl:variable name=""var:v2"" select=""userCSharp:StringSize(string(s2:ContactOrganizationType/text()))"" />
            ...
            <xsl:variable name=""var:v13"" select=""userCSharp:StringSize(string(s2:ApplicantTradeName/text()))"" />
            ...
            <xsl:variable name=""var:v18"" select=""string(s2:ApplicantTradeName/text())"" />
            ...
            <Applicants>
              <xsl:if test=""s2:ApplicantExternalID"">
                <ApplicantId>
                  <xsl:value-of select=""s2:ApplicantExternalID/text()"" />
                </ApplicantId>
              </xsl:if>
              <xsl:if test=""string($var:v3)='true'"">
                <xsl:variable name=""var:v4"" select=""s2:ContactOrganizationType/text()"" />
              ...
              <xsl:if test=""string($var:v8)='true'"">
                <xsl:variable name=""var:v9"" select=""s2:AccountBusinessType/text()"" />
              ...
              <xsl:if test=""string($var:v14)='true'"">
                <xsl:variable name=""var:v15"" select=""s2:ApplicantTradeName/text()"" />
                <LegalName>
                  <xsl:value-of select=""$var:v15"" />
                </LegalName>
              </xsl:if>
              <xsl:if test=""string($var:v16)='true'"">
                <xsl:variable name=""var:v17"" select=""s2:AccountName/text()"" />
                <LegalName>
                  <xsl:value-of select=""$var:v17"" />
                </LegalName>
              </xsl:if>
              <xsl:if test=""string($var:v21)='true'"">
                <xsl:variable name=""var:v22"" select=""s2:ContactFirstName/text()"" />
                <APL_FIRST_NAME>
                  <xsl:value-of select=""$var:v22"" />
                </APL_FIRST_NAME>
              </xsl:if>
              <xsl:if test=""string($var:v21)='true'"">
                <xsl:variable name=""var:v23"" select=""s2:ContactLastName/text()"" />
                <APL_LAST_NAME>
                  <xsl:value-of select=""$var:v23"" />
                </APL_LAST_NAME>
              </xsl:if>
              <xsl:variable name=""var:v24"" select=""userCSharp:RelationTypeValues(string(s2:ApplicantRelationType/text()))"" />
              <APL_RELATION_TYPE>
      ...
      <DocumentList>
        <xsl:for-each select=""InputMessagePart_0/s5:AppDocumentList/s5:Responses"">
          <xsl:for-each select=""s1:QueryResult"">
            <xsl:for-each select=""s1:records"">
              <xsl:variable name=""var:v25"" select=""userCSharp:LogicalExistence(boolean(s1:ContentDocument/s1:LatestPublishedVersion/s1:Id))"" />
              <xsl:variable name=""var:v26"" select=""boolean(s1:ContentDocument/s1:LatestPublishedVersion/s1:Id)"" />
              <xsl:variable name=""var:v27"" select=""userCSharp:LogicalExistence($var:v26)"" />
              <xsl:variable name=""var:v30"" select=""userCSharp:LogicalEq(string(s1:ContentDocument/s1:LatestPublishedVersion/s1:Document_Validity__c/text()) , &quot;Invalid&quot;)"" />
              ...
              <xsl:variable name=""var:v36"" select=""userCSharp:LogicalExistence(boolean(../../s5:DocumentApplicantId))"" />
              ...
              <DocumentDetails>
                ...
                <xsl:if test=""string($var:v37)='true'"">
                  <xsl:variable name=""var:v38"" select=""../../s5:DocumentApplicantId/text()"" />
                  <ApplicantId>
                    <xsl:value-of select=""$var:v38"" />
                  </ApplicantId>
                </xsl:if>
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v39"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:CreatedDate/text()"" />
                  <ReceiveDate>
                    <xsl:value-of select=""$var:v39"" />
                  </ReceiveDate>
                </xsl:if>
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v40"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:CreatedDate/text()"" />
                  <RequestDate>
                    <xsl:value-of select=""$var:v40"" />
                  </RequestDate>
                </xsl:if>
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v41"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Id/text()"" />
                  <ScanDocumentID>
                    <xsl:value-of select=""$var:v41"" />
                  </ScanDocumentID>
                </xsl:if>
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v42"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
                  <DocumentType>
                    <xsl:value-of select=""$var:v42"" />
                  </DocumentType>
                </xsl:if>
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v43"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
                  <xsl:if test=""string($var:v27)='true'"">
                    <xsl:variable name=""var:v44"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Title/text()"" />
                    <xsl:variable name=""var:v45"" select=""userCSharp:DocumnetTypeDesc(string($var:v43) , string($var:v44))"" />
                    <DocumentTitle>
                ...
                <xsl:if test=""string($var:v27)='true'"">
                  <xsl:variable name=""var:v46"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
                  <xsl:if test=""string($var:v27)='true'"">
                    <xsl:variable name=""var:v47"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Title/text()"" />
                    <xsl:variable name=""var:v48"" select=""userCSharp:DocumnetTypeDesc(string($var:v46) , string($var:v47))"" />
                    <DocumentDescription>
        ...
        <xsl:for-each select=""InputMessagePart_1/s1:QueryResult/s1:records"">
          <xsl:variable name=""var:v49"" select=""boolean(s1:ContentDocument/s1:LatestPublishedVersion/s1:Id)"" />
          <xsl:variable name=""var:v50"" select=""userCSharp:LogicalExistence($var:v49)"" />
          <xsl:variable name=""var:v53"" select=""string(s1:ContentDocument/s1:LatestPublishedVersion/s1:Document_Validity__c/text())"" />
          <xsl:variable name=""var:v54"" select=""userCSharp:LogicalEq($var:v53 , &quot;Invalid&quot;)"" />
          <xsl:variable name=""var:v55"" select=""userCSharp:LogicalNot(string($var:v54))"" />
          <xsl:variable name=""var:v56"" select=""userCSharp:LogicalAnd(string($var:v50) , string($var:v55))"" />
          <xsl:variable name=""var:v58"" select=""userCSharp:LogicalAnd(string($var:v50) , string($var:v54))"" />
          <DocumentDetails>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v51"" select=""&quot;NONE&quot;"" />
              <ChecklistType>
                <xsl:value-of select=""$var:v51"" />
              </ChecklistType>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v52"" select=""&quot;0&quot;"" />
              <ActionID>
                <xsl:value-of select=""$var:v52"" />
              </ActionID>
            </xsl:if>
            <xsl:if test=""string($var:v56)='true'"">
              <xsl:variable name=""var:v57"" select=""&quot;RECEIVED&quot;"" />
              <Status>
                <xsl:value-of select=""$var:v57"" />
              </Status>
            </xsl:if>
            <xsl:if test=""string($var:v58)='true'"">
              <xsl:variable name=""var:v59"" select=""&quot;REJECTED&quot;"" />
              <Status>
                <xsl:value-of select=""$var:v59"" />
              </Status>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v60"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:CreatedDate/text()"" />
              <ReceiveDate>
                <xsl:value-of select=""$var:v60"" />
              </ReceiveDate>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v61"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:CreatedDate/text()"" />
              <RequestDate>
                <xsl:value-of select=""$var:v61"" />
              </RequestDate>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v62"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Id/text()"" />
              <ScanDocumentID>
                <xsl:value-of select=""$var:v62"" />
              </ScanDocumentID>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v63"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
              <DocumentType>
                <xsl:value-of select=""$var:v63"" />
              </DocumentType>
            </xsl:if>
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v64"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
              <xsl:if test=""string($var:v50)='true'"">
                <xsl:variable name=""var:v65"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Title/text()"" />
                <xsl:variable name=""var:v66"" select=""userCSharp:DocumnetTypeDesc(string($var:v64) , string($var:v65))"" />
                <DocumentTitle>
            ...
            <xsl:if test=""string($var:v50)='true'"">
              <xsl:variable name=""var:v67"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:DLAP_Document_Type__c/text()"" />
              <xsl:if test=""string($var:v50)='true'"">
                <xsl:variable name=""var:v68"" select=""s1:ContentDocument/s1:LatestPublishedVersion/s1:Title/text()"" />
                <xsl:variable name=""var:v69"" select=""userCSharp:DocumnetTypeDesc(string($var:v67) , string($var:v68))"" />
                <DocumentDescription>
        ...
        <xsl:for-each select=""InputMessagePart_3/s0:Response/s0:row"">
          <xsl:variable name=""var:v70"" select=""userCSharp:LogicalNe(string(s0:Checklist_Item_Status__c/text()) , &quot;Finalized&quot;)"" />
          <xsl:if test=""$var:v70"">
            <xsl:variable name=""var:v72"" select=""userCSharp:LogicalExistence(boolean(s0:Id))"" />
            <xsl:variable name=""var:v74"" select=""boolean(s0:Id)"" />
            <xsl:variable name=""var:v75"" select=""userCSharp:LogicalExistence($var:v74)"" />
            <xsl:variable name=""var:v77"" select=""userCSharp:LogicalExistence(boolean(s0:ApplicantExternalId))"" />
            <xsl:variable name=""var:v79"" select=""userCSharp:LogicalExistence(boolean(s0:Verified_Date__c))"" />
            <xsl:variable name=""var:v86"" select=""string(s0:Type__c/text())"" />
            <xsl:variable name=""var:v87"" select=""userCSharp:LogicalEq($var:v86 , &quot;Closing Documents&quot;)"" />
            <xsl:variable name=""var:v88"" select=""userCSharp:LogicalNot(string($var:v87))"" />
            <DocumentDetails>
              <xsl:variable name=""var:v71"" select=""userCSharp:TypeValues(string(s0:Type__c/text()))"" />
              <ChecklistType>
                <xsl:value-of select=""$var:v71"" />
              </ChecklistType>
              <xsl:if test=""string($var:v72)='true'"">
                <xsl:variable name=""var:v73"" select=""s0:Id/text()"" />
                <ActionID>
                  <xsl:value-of select=""$var:v73"" />
                </ActionID>
              </xsl:if>
              <xsl:if test=""string($var:v75)='true'"">
                <xsl:variable name=""var:v76"" select=""&quot;REQUESTED&quot;"" />
                <Status>
                  <xsl:value-of select=""$var:v76"" />
                </Status>
              </xsl:if>
              <xsl:if test=""string($var:v77)='true'"">
                <xsl:variable name=""var:v78"" select=""s0:ApplicantExternalId/text()"" />
                <ApplicantId>
                  <xsl:value-of select=""$var:v78"" />
                </ApplicantId>
              </xsl:if>
              <xsl:if test=""string($var:v79)='true'"">
                <xsl:variable name=""var:v80"" select=""s0:Verified_Date__c/text()"" />
                <ReceiveDate>
              ...
              <xsl:if test=""string($var:v75)='true'"">
                <xsl:variable name=""var:v81"" select=""&quot;0&quot;"" />
                <ScanDocumentID>
                  <xsl:value-of select=""$var:v81"" />
                </ScanDocumentID>
              </xsl:if>
              <xsl:variable name=""var:v82"" select=""userCSharp:DOCTypeValues(string(s0:DocumentType__c/text()))"" />
              <xsl:variable name=""var:v83"" select=""userCSharp:StringSize(string($var:v82))"" />
              <xsl:variable name=""var:v84"" select=""userCSharp:LogicalGt(string($var:v83) , &quot;2&quot;)"" />
              <xsl:if test=""string($var:v84)='true'"">
                <xsl:variable name=""var:v85"" select=""string($var:v82)"" />
                <DocumentType>
              ...
              <xsl:if test=""string($var:v88)='true'"">
                <xsl:variable name=""var:v89"" select=""s0:MasterCheckListDescription/text()"" />
                <DocumentDescription>
                  <xsl:value-of select=""$var:v89"" />
                </DocumentDescription>
              </xsl:if>
              <xsl:if test=""string($var:v87)='true'"">
                <xsl:variable name=""var:v90"" select=""&quot;Closing Documents Signature Required&quot;"" />
                <DocumentDescription>
        ...
        <xsl:for-each select=""InputMessagePart_4/s5:ChecklistItemDocumentList/s5:Responses"">
          <xsl:for-each select=""s4:QueryResult"">
            <xsl:for-each select=""s4:records"">
              <xsl:variable name=""var:vId"" select=""s4:LinkedEntityId/text()"" />
              <xsl:variable name=""var:v91"" select=""userCSharp:LogicalExistence(boolean(s4:ContentDocument/s4:LatestPublishedVersion/s4:Id))"" />
              <xsl:variable name=""var:v93"" select=""boolean(s4:ContentDocument/s4:LatestPublishedVersion/s4:Id)"" />
              <xsl:variable name=""var:v94"" select=""userCSharp:LogicalExistence($var:v93)"" />
              <!--Reterving Checklist Item Status From Checklist Item Response-->
              <xsl:variable name=""var:v95000"" select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_3' and namespace-uri()='']/*[local-name()='Response' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/*[local-name()='row' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c'][*[local-name()='Id' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/text()= $var:vId]/*[local-name()='Checklist_Item_Status__c' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']"" />
              <xsl:variable name=""var:v96"" select=""userCSharp:LogicalEq(string($var:v95000) , &quot;Invalid&quot;)"" />
              <xsl:variable name=""var:v97"" select=""userCSharp:LogicalNot(string($var:v96))"" />
              <xsl:variable name=""var:v98"" select=""userCSharp:LogicalAnd(string($var:v94) , string($var:v97))"" />
              <xsl:variable name=""var:v100"" select=""userCSharp:LogicalAnd(string($var:v94) , string($var:v96))"" />
              <DocumentDetails>
                <xsl:if test=""string($var:v91)='true'"">
                  <!--Reterving Checklist Item Type__c From Checklist Item Response-->
                  <xsl:variable name=""var:v9100"" select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_3' and namespace-uri()='']/*[local-name()='Response' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/*[local-name()='row' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c'][*[local-name()='Id' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/text()= $var:vId]/*[local-name()='Type__c' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']"" />
                  <xsl:variable name=""var:v9200"" select=""userCSharp:TypeValues(string($var:v9100))"" />
                  <ChecklistType>
                    <xsl:value-of select=""$var:v9200"" />
                  </ChecklistType>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <xsl:variable name=""var:v95"" select=""&quot;0&quot;"" />
                  <ActionID>
                    <xsl:value-of select=""$var:v95"" />
                  </ActionID>
                </xsl:if>
                <xsl:if test=""string($var:v98)='true'"">
                  <xsl:variable name=""var:v99"" select=""&quot;RECEIVED&quot;"" />
                  <Status>
                    <xsl:value-of select=""$var:v99"" />
                  </Status>
                </xsl:if>
                <xsl:if test=""string($var:v100)='true'"">
                  <xsl:variable name=""var:v101"" select=""&quot;REJECTED&quot;"" />
                  <Status>
                    <xsl:value-of select=""$var:v101"" />
                  </Status>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <!--Reterving Checklist Item Applicant Id From Checklist Item Response-->
                  <xsl:variable name=""var:v102000"" select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_3' and namespace-uri()='']/*[local-name()='Response' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/*[local-name()='row' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c'][*[local-name()='Id' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/text()= $var:vId]/*[local-name()='Applicant__c' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']"" />
                  <ApplicantId>
                    <xsl:value-of select=""$var:v102000"" />
                  </ApplicantId>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <xsl:variable name=""var:v82000"" select=""s4:ContentDocument/s4:LatestPublishedVersion/s4:CreatedDate/text()"" />
                  <ReceiveDate>
                    <xsl:value-of select=""$var:v82000"" />
                  </ReceiveDate>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <xsl:variable name=""var:v83000"" select=""s4:ContentDocument/s4:LatestPublishedVersion/s4:CreatedDate/text()"" />
                  <RequestDate>
                    <xsl:value-of select=""$var:v83000"" />
                  </RequestDate>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <xsl:variable name=""var:v103"" select=""s4:ContentDocument/s4:LatestPublishedVersion/s4:Id/text()"" />
                  <ScanDocumentID>
                    <xsl:value-of select=""$var:v103"" />
                  </ScanDocumentID>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <xsl:variable name=""var:v104"" select=""&quot;99&quot;"" />
                  <DocumentType>
                    <xsl:value-of select=""$var:v104"" />
                  </DocumentType>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <!--Reterving Master CheckList Name From Checklist Item Response-->
                  <xsl:variable name=""var:v105000"" select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_3' and namespace-uri()='']/*[local-name()='Response' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/*[local-name()='row' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c'][*[local-name()='Id' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/text()= $var:vId]/*[local-name()='MasterCheckListName' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']"" />
                  <DocumentTitle>
                    <xsl:value-of select=""$var:v105000"" />
                  </DocumentTitle>
                </xsl:if>
                <xsl:if test=""string($var:v94)='true'"">
                  <!--Reterving MasterCheckList Description From Checklist Item Response-->
                  <xsl:variable name=""var:v106000"" select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_3' and namespace-uri()='']/*[local-name()='Response' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/*[local-name()='row' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c'][*[local-name()='Id' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']/text()= $var:vId]/*[local-name()='MasterCheckListDescription' and namespace-uri()='http://SBA.gov/DLAPDocumentList/Checklist_Item__c']"" />
                  <DocumentDescription>
                    <xsl:value-of select=""$var:v106000"" />
                  </DocumentDescription>
                </xsl:if>
              </DocumentDetails>
            </xsl:for-each>
...
public bool ValToBool(string val)
{
	...
	return false;
        ...
        private const string _strSrcSchemasList0 = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_Document_Details";
        
        private const global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_Document_Details _srcSchemaTypeReference0 = null;
        
        private const string _strSrcSchemasList1 = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Document_Details+QueryResult";
        
        private const global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Document_Details.QueryResult _srcSchemaTypeReference1 = null;
        ...
        private const string _strSrcSchemasList4 = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_ChecklistItem_Document_Details";
        
        private const global::DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_ChecklistItem_Document_Details _srcSchemaTypeReference4 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_Document_Details";
                _SrcSchemas[1] = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Document_Details+QueryResult";
                ...
                _SrcSchemas[4] = @"DLAPDocumentListSalesforceDefinition.Rest_Schemas.Rest_Multiple_ChecklistItem_Document_Details";
                return _SrcSchemas;
            }
        }
