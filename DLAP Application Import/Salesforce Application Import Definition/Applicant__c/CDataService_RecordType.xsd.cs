namespace Salesforce_Application_Import_Definition_XSD {
    ...
    public sealed class CDataService_RecordType : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""table"">
    <xs:complexType>
      ...
      <xs:attribute name=""AffectedRows"" type=""xs:int"" />
        ...
        public CDataService_RecordType() {
        }
        ...
        [Schema(@"http://sba-oda/DLAP/RecordType",@"parameters")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://sba-oda/DLAP/RecordType",@"table")]
        [System.SerializableAttribute()]
