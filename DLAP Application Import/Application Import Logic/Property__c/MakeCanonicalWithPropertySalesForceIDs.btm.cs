namespace Application_Import_Logic.Property__c {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Salesforce_Application_Import_Definition_XSD.CDataServiceDamaged_Property__c+table", typeof(global::Salesforce_Application_Import_Definition_XSD.CDataServiceDamaged_Property__c.table))]
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Application_Import_Definition.HomeDisasterLoanApplicationCanonical", typeof(global::Application_Import_Definition.HomeDisasterLoanApplicationCanonical))]
    public sealed class MakeCanonicalWithPropertySalesForceIDs : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 s1"" version=""1.0"" xmlns:s0=""http://sba-oda/DLAP/DamagedProperty__c"" xmlns:s1=""http://schemas.microsoft.com/BizTalk/2003/aggschema"" xmlns:ns0=""http://SBA.ODA.Gov/CanonicalApplication"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">
          ...
          <xsl:for-each select=""Dmg_Properties"">
            ...
            <Dmg_Properties>
              ...
              <xsl:call-template name=""PropertySalesForceID"">
                <xsl:with-param name=""SFPropRows"" select=""string($var:v3)"" />
              </xsl:call-template>
            </Dmg_Properties>
          </xsl:for-each>
        </xsl:for-each>
...
<xsl:value-of select=""/*[local-name()='Root' and namespace-uri()='http://schemas.microsoft.com/BizTalk/2003/aggschema']/*[local-name()='InputMessagePart_0' and namespace-uri()='']/*[local-name()='table' and namespace-uri()='http://sba-oda/DLAP/DamagedProperty__c']/*[local-name()='row' and namespace-uri()='http://sba-oda/DLAP/DamagedProperty__c'][number($SFPropRows)]/*[local-name()='Id' and namespace-uri()='http://sba-oda/DLAP/DamagedProperty__c']/text()"" />
        ...
        private const string _strSrcSchemasList0 = @"Salesforce_Application_Import_Definition_XSD.CDataServiceDamaged_Property__c+table";
        
        private const global::Salesforce_Application_Import_Definition_XSD.CDataServiceDamaged_Property__c.table _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"Salesforce_Application_Import_Definition_XSD.CDataServiceDamaged_Property__c+table";
