namespace Application_Import_Definition {
    ...
    [Schema(@"",@"Application")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_ELA_REFERENCE_NBR), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ELA_REFERENCE_NBR' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_CREATE_DATE), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_CREATE_DATE' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_FEMA_REGIS_NBR), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_FEMA_REGIS_NBR' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_ID), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ID' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_PRO_ID), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_PRO_ID' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Application_Import_Definition.APP_SUBMIT_DATE), XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_SUBMIT_DATE' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "APP_ELA_REFERENCE_NBR", XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ELA_REFERENCE_NBR' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "APP_SUMMARY_DECLINE_CODE", XPath = @"/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_SUMMARY_DECLINE_CODE' and namespace-uri()='']", XsdType = @"string")]
    ...
    public sealed class HomeDisasterLoanApplication : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns0=""https://Application_Import_Definition.DLAP_Property_Schema"" attributeFormDefault=""unqualified"" elementFormDefault=""qualified"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <b:imports>
  ...
  <xs:element name=""Application"">
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          <b:property name=""ns0:APP_ELA_REFERENCE_NBR"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ELA_REFERENCE_NBR' and namespace-uri()='']"" />
          <b:property name=""ns0:APP_CREATE_DATE"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_CREATE_DATE' and namespace-uri()='']"" />
          <b:property name=""ns0:APP_FEMA_REGIS_NBR"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_FEMA_REGIS_NBR' and namespace-uri()='']"" />
          <b:property name=""ns0:APP_ID"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ID' and namespace-uri()='']"" />
          <b:property name=""ns0:APP_PRO_ID"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_PRO_ID' and namespace-uri()='']"" />
          <b:property name=""ns0:APP_SUBMIT_DATE"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_SUBMIT_DATE' and namespace-uri()='']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_ELA_REFERENCE_NBR' and namespace-uri()='']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='Application' and namespace-uri()='']/*[local-name()='APP_SUMMARY_DECLINE_CODE' and namespace-uri()='']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
              ...
              <xs:element maxOccurs=""unbounded"" name=""Applicants"">
                <xs:complexType>
                  <xs:sequence>
                    ...
                    <xs:element name=""AplWageColl"">
                      <xs:complexType>
                        <xs:sequence minOccurs=""0"">
                          <xs:element name=""Apl_Wages"">
                            <xs:complexType>
                              <xs:sequence>
                                <xs:element name=""ApplicantId"" type=""xs:string"" />
                    ...
                    <xs:element name=""AplOtherIncomeColl"">
                      <xs:complexType>
                        <xs:sequence minOccurs=""0"">
                          <xs:element name=""Apl_Other_Income"">
                            <xs:complexType>
                              <xs:sequence>
                                <xs:element name=""ApplicantId"" type=""xs:string"" />
        ...
        <xs:element name=""DmgPropertyColl"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""Dmg_Properties"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element name=""AppId"" type=""xs:string"" />
                    ...
                    <xs:element name=""DpoInsuranceColl"">
                      <xs:complexType>
                        <xs:sequence>
                          <xs:element name=""Dpo_Insurances"">
                            <xs:complexType>
                              <xs:sequence>
                                <xs:element name=""DmgPropertyId"" type=""xs:string"" />
        ...
        <xs:element name=""DpoDupBenefitColl"">
          <xs:complexType>
            <xs:sequence>
        ...
        <xs:element name=""Debts"">
          <xs:complexType>
            <xs:sequence>
              ...
              <xs:element name=""HazardInsurance"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element name=""Amount"" type=""xs:string"" />
                    <xs:element name=""Frequency"" type=""xs:string"" />
              ...
              <xs:element name=""OtherDebtColl"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element name=""OtherDebt"">
                      <xs:complexType>
                        <xs:sequence>
        ...
        <xs:element name=""ExtraExpenseColl"">
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""Apl_Ext_Expense"">
                <xs:complexType>
                  <xs:sequence>
        ...
        public HomeDisasterLoanApplication() {
        }
