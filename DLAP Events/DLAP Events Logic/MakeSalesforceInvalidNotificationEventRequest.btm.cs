namespace DLAPEventsLogic {
    ...
    public sealed class MakeSalesforceInvalidNotificationEventRequest : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        ...
        <ns0:after>
          <ns0:Event_Request__c>
            ...
            <xsl:attribute name=""Log_Message__c"">
              <xsl:text>DLAP Events SF Notification Request Validation Failed for STATUS/DOCUMENT</xsl:text>
            </xsl:attribute>
