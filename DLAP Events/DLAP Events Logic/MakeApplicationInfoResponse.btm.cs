namespace DLAPEventsLogic {
    ...
    public sealed class MakeApplicationInfoResponse : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:ns0=""http://SBA.gov/DLAPEvents/Application_Info__c"" xmlns:s0=""http://SBA.gov/REST/Query/DLAPEvents/CheckStatusApplicationInfoResponse"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s0:QueryResult"">
    <ns0:Response>
      <xsl:for-each select=""s0:records"">
        <xsl:for-each select=""s0:Applicants__r/s0:records"">
          ...
          <ns0:row>
            ...
            <ns0:DLAP_Status_Description__c>
...
public bool ValToBool(string val)
{
	...
	return false;
        ...
        private const string _strTrgSchemasList0 = @"DLAPEventsSalesforceDefinition.SalesforceQuery__Application_Info__c+Response";
        
        private const global::DLAPEventsSalesforceDefinition.SalesforceQuery__Application_Info__c.Response _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"DLAPEventsSalesforceDefinition.SalesforceQuery__Application_Info__c+Response";
                return _TrgSchemas;
            }
        }
    }
